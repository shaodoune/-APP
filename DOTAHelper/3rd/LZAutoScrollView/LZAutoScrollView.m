...
//        NSLog(@"%ld",self.currentImageIndex);
//        NSString *str=[NSString stringWithFormat:@"%ld",self.currentImageIndex];
//        [[NSNotificationCenter defaultCenter]postNotificationName:@"news" object:nil userInfo:@{@"Clicked":str}];
        self.itemClicked(self.currentImageIndex);
    }
}
